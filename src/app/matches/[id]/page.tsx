 ...
 * now live inline on the parent game page's match carousel.
 *
 ...
 * `src/app/games/[id]/components/MatchDetailCard.tsx`.
 */
...
export default function MatchRedirectPage() {
  ...
  useEffect(() => {
    ...
    const run = async () => {
      ...
      // the game URL. Game page reads these and delegates to
